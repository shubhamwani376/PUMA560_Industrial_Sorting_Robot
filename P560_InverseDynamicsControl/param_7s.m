...
tseg_i = [0.7,0.7,0.7]; % time per segment
...
tseg_p = [0.7,0.7,0.7,0.7]; % time per segment
...
tf = (tf_i + tf_c + tf_p +tf_f) - 0.6; %simulating till 7 s
...
% % Initialize video
% RobotTrajectory7_Video = VideoWriter('RobotTrajectory7_Video','MPEG-4');
% RobotTrajectory7_Video.FrameRate = 10;
% open(RobotTrajectory7_Video)
% 
...
%     writeVideo(RobotTrajectory7_Video, frame);
% 
% end
% hold off;
% close(RobotTrajectory7_Video);